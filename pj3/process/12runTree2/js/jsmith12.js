window.onload = function(){
      var $window = $(window);
      var $canvas = $('<canvas id="canvas" width="' + $window.width() + '" height="' + $window.height() + '">Your browser doesn\'t support canvas. Boo-hiss.</canvas>');
      $('body').prepend($canvas);
      ...
      var canvas = document.getElementById("canvas");
          ...
          var getRandomColor = function(){
            ...
            return color2[randomColor];
      		...
      		if(length < 10) ctx.strokeStyle = getRandomColor();
