...
function Ball (startX, startY, startVelX, startVelY) {
  ...
  this.draw = function(ctx, can) {
    ...
    if (distMouse(this) > 100) {
      ...
      ctx.strokeStyle= "#616668";

    }

    ctx.arc((50 + this.x) | 0, (50 + this.y) | 0, 3, 0, TAU, false);
    ctx.fill();
    ...
    var dist = Math.hypot(ball.x - ball2.x, ball.y - ball2.y);
        if (dist < 100) {
          if (distMouse(ball) > 100) {
            ...
            ctx.strokeStyle = "#F2E8C4";
            ctx.globalAlpha =  0.8;
          }
          ctx.lineWidth = "10px";
          ctx.moveTo((50 + ball.x) | 0, (50 + ball.y) | 0);
          ctx.lineTo((50 + ball2.x) | 0, (50 + ball2.y) | 0);
        }
}
    ctx.stroke();
  }
