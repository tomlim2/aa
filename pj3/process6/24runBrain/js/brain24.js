$(document).ready(function() {
      ...
      recursiveTree(ctx, 800, 705, 22, -Math.PI / 1.2, 13, 3);
					recursiveTree(ctx, 800, 705, 32, -Math.PI / 1.4, 13, 3);
          recursiveTree(ctx, 800, 705, 22, -Math.PI / 1.6, 13, 3);
          recursiveTree(ctx, 800, 705, 42, -Math.PI / 2, 13, 3);
          recursiveTree(ctx, 800, 705, 22, -Math.PI / 2.4, 13, 3);
          recursiveTree(ctx, 800, 705, 32, -Math.PI / 2.6, 13, 3);
          recursiveTree(ctx, 800, 705, 22, -Math.PI / 2.8, 13, 3);
				}
			});
